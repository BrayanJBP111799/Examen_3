        ...
        <div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-responsive-page1" data-title="Box-Games">
            ...
            <div data-role="main" class="ui-content jqm-content jqm-fullwidth">
                ...
                <div class="alert alert-info">
                    ...
                    <a href='pay.action?submitType=loaddata&idc=<s:property value="#session.session_cedula"/>&precio=<s:property value="total"></s:property>' rel="external" style="text-decoration:none; color:#fff;" class="btn btn-success float-right">Pagar</a>
                    <br>
                    <br>
                </div>
            </div>
