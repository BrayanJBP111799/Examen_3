            ...
            <div data-role="main" class="ui-content jqm-content jqm-fullwidth">
                <div class="sign-in-body">
                    <center><form class="form-redirect" style="border:solid 3px #328BC3; border-radius:10px; margin-top:25px;">
                            <div><img src="img/logos/dice.png" width="70"></div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="checkbox mb-3">
                                    <center>                                
                                        <a onclick="location.href = 'index.jsp'" class="btn btn-blueBG" style="margin: 20px auto; color:#fff; text-decoration:none;">Regresar al inicio</a>
                                    </center>
                                </div>  
                            </div>
                        </form></center>
