 ...
 * generated in the paymentWS package. 
...
public class ObjectFactory {
    ...
    private final static QName _Pagos_QNAME = new QName("http://schemas.datacontract.org/2004/07/Payment_Services", "Pagos");
    ...
    /**
     * Create an instance of {@link InsertPayment }
     * 
     */
    public InsertPayment createInsertPayment() {
        return new InsertPayment();
    }

    /**
     * Create an instance of {@link InsertPaymentResponse }
     * 
     */
    public InsertPaymentResponse createInsertPaymentResponse() {
        return new InsertPaymentResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Payment_Services", name = "Pagos")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "nombre", scope = InsertPayment.class)
    public JAXBElement<String> createInsertPaymentNombre(String value) {
        return new JAXBElement<String>(_InsertPaymentNombre_QNAME, String.class, InsertPayment.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "InsertPaymentResult", scope = InsertPaymentResponse.class)
    public JAXBElement<Pagos> createInsertPaymentResponseInsertPaymentResult(Pagos value) {
        return new JAXBElement<Pagos>(_InsertPaymentResponseInsertPaymentResult_QNAME, Pagos.class, InsertPaymentResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Payment_Services", name = "Fecha_Ven", scope = Pagos.class)
    public JAXBElement<String> createPagosFechaVen(String value) {
        return new JAXBElement<String>(_PagosFechaVen_QNAME, String.class, Pagos.class, value);
    }
