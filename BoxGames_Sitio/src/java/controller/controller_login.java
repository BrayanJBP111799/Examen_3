...
public class controller_login extends ActionSupport implements SessionAware {
    ...
    public String execute() throws SQLException {
        ...
        if ("sinregistro".equals(da.consulta_inicio(getU()))) {
            ...
            if ("sinonboarding".equals(da.consulta_onboarding(getU()))) {
                result = "correcto";
            }else if("inactivo".equals(da.consulta_onboarding(getU()))){
                result = "correcto";
            }else if("activo".equals(da.consulta_onboarding(getU()))){
                result = "onboarding";
            }
        }
