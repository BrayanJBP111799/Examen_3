            ...
            <div class="container">
                <div class="sign-in-body">
                    <center><form class="form-redirect" style="border:solid 3px #328BC3; border-radius:10px; margin-top:25px;">
                        ...
                        <h3 class="mb-3 font-weight-normal text-green">¡El juego se ha eliminado exitosamente!</h3>
                        <div class="col-md-5">
                        <center><img src="https://image.flaticon.com/icons/svg/1141/1141123.svg" width="128" height="128" alt="hand"></center>
                        <br><br>   
                        
                        <div class="checkbox mb-3">
                            <center>   
                                <a href='viewcarrito?idC=<s:property value="#session.session_cedula"/>' rel="external" style="text-decoration:none; color:#328BC3;">
                                    Volver al Carrito
                                </a>
                                <!--<a href="login.jsp" class="btn btn-success">Volver al Carrito</a>-->
                            </center>
                        </div>  
                        </div>
                    </form></center>
