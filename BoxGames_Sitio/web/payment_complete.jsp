            ...
            <div class="container">
                <div class="sign-in-body">
                    <center><form class="form-redirect" style="border:solid 3px #328BC3; border-radius:10px; margin-top:25px;">
                        ...
                        <h3 class="mb-3 font-weight-normal text-green">¡Tu compra se ha finalizado correctamente!</h3>
                        <div class="col-md-5">
                        <center><img src="https://image.flaticon.com/icons/svg/1087/1087080.svg" width="128" height="128" alt="hand"></center>
                        <br><br>   
